...
@Service
public class ZkServiceImpl implements ZkService, Watcher {
    ...
    public void addNode(String path) {
        ...
        try {
            String node = zooKeeper.create(path, "保存的数据".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
     ...
     * 判断节点是否存在
     */
    public void checkPathExist(String path) {
        try {
     ...
     * @param path
     */
    public void nodeChildren(String path) {
        try {
